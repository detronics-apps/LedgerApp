...
export function buildLogForm({ categories, tasks, initialValues = null, onSubmit, onCancel = null }) {
  ...
  form.append(
    ...
    field('How much impact did you think it had?', pickerHost.impact, {
      info: 'Score what actually happened - not a hypothetical, and not just how many people it reached. See "How do I judge impact fairly?" on the How-to page for the full explanation.',
    }),
